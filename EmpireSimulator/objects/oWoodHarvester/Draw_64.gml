...
draw_text_transformed(healthbar_x + 27, healthbar_y - 18, "WOOD HARVESTER", 0.5, 0.5, 0);
...
draw_set_halign(fa_center);
draw_text_transformed(guiWidth / 2, 50, "WOOD HARVESTER", 2, 2, 0);
...
for(var i = 0; i < itemCount; i++){
    ...
    if(name == "Upgrade" || name == "> Upgrade <"){
        ...
        draw_text(_x - 200, _y, "Increases Production");
        draw_set_halign(fa_center);
